...
class LoadDataset(object):
    ...
    def get_data_loader(self):
        train_set = CustomDataset(self.datasets_dir, self.num_fold, mode='train')
        val_set = CustomDataset(self.datasets_dir, self.num_fold, mode='val')
        test_set = CustomDataset(self.datasets_dir, self.num_fold, mode='test')
