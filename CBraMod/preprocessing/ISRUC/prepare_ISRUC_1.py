...
dir_path = r'/path/to/datasets/ISRUC_extracted/group1'

seq_dir = r'/path/to/datasets/ISRUC/precessed_filter_35/seq'
label_dir = r'/path/to/datasets/ISRUC/precessed_filter_35/labels'
