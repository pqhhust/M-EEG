...
root_dir = '/path/to/datasets/eeg-motor-movementimagery-dataset-1.0.0/files'
...
db = lmdb.open('/path/to/datasets/eeg-motor-movementimagery-dataset-1.0.0/processed_average', map_size=4614542346)
