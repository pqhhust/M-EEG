...
# PARAMETERS
signals_path = r"/path/to/datasets/chb-mit-scalp-eeg-database-1.0.0"  # Path to the data main directory
clean_path = r"/path/to/datasets/chb-mit/processed"  # Path where to store clean data
