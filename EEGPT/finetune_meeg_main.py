...
# import wandb
from datasets.downstream import parkinson_meeg_dataset
from finetune_trainer_meeg import Trainer
from downstream import model_for_parkinson_meeg as model_parkinson
...
def main():
    ...
    for i in range(3):
        ...
        if params.downstream_dataset == 'ParkinsonMEEG':
            ...
            load_dataset = parkinson_meeg_dataset.LoadDataset(params)
